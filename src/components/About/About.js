          ...
          <div className="about__details-container">
            ...
            >
              <Link to="/about/intro">
                ...
                <p>
                  I am <span>Pratyush.</span> <br /> Highly passoinate
            ...
            >
              <Link to="/about/internships">
                ...
                <ul>
                  <li>
                    <span>Google</span> - Front-end Developer{" "}
                  </li>
                  <li>
                    <span>Facebook</span> - Front-end Developer{" "}
                  </li>
                  <li>
                    <span>Microsoft</span> - Front-end Developer{" "}
                  </li>
                </ul>
              </Link>
            </div>
            ...
            >
              <Link to="/about/graduation">
                ...
                <p>
                  <span>Karnataka Govt Polytechnic</span>
                  <br />
                  KPT (Karnataka Polytechnic) College in Mangalore is a well-known educational institution offering diploma courses in various engineering disciplines. Established in 1946, it is one of the oldest polytechnic colleges in Karnataka.
                </p>
              </Link>
            </div>
          </div>
